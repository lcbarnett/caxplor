...
)
{
	...
	FILE* const gp = gp_popen(NULL,"Discrete power spectrum",0,0);
	fprintf(gp,"set size ratio -1\n");
	fprintf(gp,"unset xtics\n");
	fprintf(gp,"unset ytics\n");
	fprintf(gp,"set palette defined (%s)\n",gp_palette[1]);
	fprintf(gp,"set cbr [0:*]\n");
...
)
{
	...
	FILE* const gp1 = gp_popen(NULL,"Auto-MI: heat map",260,0);
	...
	FILE* const gp2 = gp_popen(NULL,"Auto-MI: medians",2480,480);
